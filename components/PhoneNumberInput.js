...
const PhoneNumberInput = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', flex: 1 }}>
            ...
            <PhoneInput ref={phoneInput} defaultCode="US" placeholder="347-491-5062" defaultValue={phoneNumber} style={{ fontSize: 30 }} autoFocus withDarkTheme onChangeFormattedText={(text) => {
                setPhoneNumber(text);
            }}></PhoneInput>
