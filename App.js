...
const App = () => {
  return (
    <>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Onboard3">
          ...
          <Stack.Screen name="Verification" component={Verification} options={{headerTitle: 'Sign up', headerShow: false, headerBackVisible: true, headerShadowVisible: false, headerStyle: {color: 'white'}}}></Stack.Screen>
          <Stack.Screen name="Onboard3" component={Onboard3} options={{headerTitle: 'Set up your profile', headerShow: false, headerBackVisible: true, headerShadowVisible: false, headerStyle: {color: 'white'}}}></Stack.Screen>
          <Stack.Screen name="Prompt" component={Prompt} options={{headerTitle: 'Set up your profile', headerShow: false, headerBackVisible: true, headerShadowVisible: false, headerStyle: {color: 'white'}}}></Stack.Screen>
        </Stack.Navigator>
      </NavigationContainer>
    </>
  );
